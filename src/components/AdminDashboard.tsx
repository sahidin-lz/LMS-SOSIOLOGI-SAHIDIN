...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({
  ...
  const handleAddCourseSubmit = (e: React.FormEvent) => {
    ...
    const newCourseObj: Course = {
      id: courseId,
      title: courseTitle,
      description: courseDesc || 'Modul Pembelajaran Sosiologi Humanis & TKA',
      grade_level: courseGrade,
      category: `Sosiologi SMA Kelas ${courseGrade}`,
  ...
  return (
    <div className="space-y-8 pb-12">
      ...
      {/* TAB 1: INPUT MODUL & MATERI PEMBELAJARAN */}
      {adminTab === 'courses' && (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 bg-white p-6 rounded-3xl border border-slate-200 shadow-sm space-y-4">
            <div className="flex items-center space-x-2 border-b border-slate-100 pb-3">
              ...
              <h2 className="text-base font-bold text-slate-800">Form Input Modul & Materi</h2>
            </div>
            ...
            <form onSubmit={handleAddCourseSubmit} className="space-y-3 text-xs">
              <div>
                ...
                <input
                  type="text"
                  required
                  placeholder="Misal: Sosiologi Perubahan Sosial & Globalisasi"
                  value={courseTitle}
      ...
      {adminTab === 'exams' && (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* Form Buat Paket Tryout & Input Soal */}
