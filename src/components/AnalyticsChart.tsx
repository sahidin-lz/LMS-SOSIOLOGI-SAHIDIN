...
export const AnalyticsChart: React.FC<AnalyticsChartProps> = ({ analytics, latestScore }) => {
  return (
    <div className="bg-white rounded-3xl p-6 border border-slate-200 shadow-sm space-y-4">
      ...
      {/* Recharts Line Graph */}
      {analytics.length === 0 ? (
        <div className="h-64 w-full flex items-center justify-center bg-slate-50 rounded-2xl border border-slate-100 italic text-white0 text-[11px]">
      ...
      <div className="flex items-center justify-between text-xs text-white0 bg-slate-50 p-3 rounded-2xl border border-slate-100">
